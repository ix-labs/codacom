...
LOCAL_DIR="/www/codacom/www-prod"
...
#Whitelists
export WL_RAW=""
export WL_INPUT="karate.txt football.txt"
export WL_METHOD="walktrap louvain leading_eigenvector label_prop"
export WL_QF=""
export WL_CM=""

#Due to a lack of dependancies, some methods may be ignored
export EXCEPT_METHOD=' lexdfs mcl '
